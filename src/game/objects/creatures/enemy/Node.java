...
// Отвечает за представление узлов в алгоритме поиска пути, который используется для нахождения кратчайшего пути от врага до игрока.
...
public class Node implements Comparable<Node> {
    ...
    // Возвращает начальное направление движения
    ...
    // Сравнивает узлы по расстоянию до цели
    @Override
