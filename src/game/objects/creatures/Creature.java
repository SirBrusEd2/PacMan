...
// Абстрактный класс для игрока или врага.
// Он определяет общие свойства и методы, которые присущи всем существам.
...
public abstract class Creature extends GameObject {
    ...
    // Конструктор класса Creature, инициализирует существо (Игрока и врагов)
    ...
    // Сбрасывает существо в начальное состояние
    public void reset() {
        centerX = initialX;
        centerY = initialY;
    ...
    /* Отвечает за обновление состояния существа (игрока или врага) в игре.
    Он вызывается в игровом цикле для каждого существа и обновляет его координаты,
    направление движения и проверяет столкновения со стенами.*/
    public void tick() {
        tickMovingDirection();
